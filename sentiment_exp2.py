...
if __name__ == '__main__':
    ...
    data_scale_range = range(20, 200, 20)
        ...
        for i in range(max_sampling_time):
            ...
            for generate_method_name in generate_methods:  # 一个样本文件在 每个生成方法下生成数据
                for j in range(max_generate_sum):
                    generate_file = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
                    if generate_method_name == 'Mymodel_generate':
                        generating_fixed_annotator(crowd_file, truth_file, exist_annotator, generate_method_name, generate_file)  # 生成20个数据集
                    else:
                        pool.apply_async(generating_fixed_annotator,
                                         args=(crowd_file, truth_file, exist_annotator, generate_method_name, generate_file))
    ...
    #
    # mean_KL_list = []
    # mean_KL_path = main_dir + '/sentiment_2/KL_mean.csv'
    #
    # std_KL_list = []
    # std_KL_path = main_dir + '/sentiment_2/KL_std.csv'
    #
    # for number in data_scale_range:
    #     for generate_method_name in generate_methods:  # 生成方法 5
    #         KL_list = []
    #         KL_path = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/KL_total.csv'
    #         for i in range(max_sampling_time):
    #             for j in range(max_generate_sum):
    #                 generate_file = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/' + str(
    #                     i) + '_' + str(j) + '.txt'
    ...
    #
    #     mean_KS_stat_list = []
    #     mean_KS_stat_path = main_dir + '/sentiment_2/' + str(number) + '/KS_stat_mean.csv'
    #     std_KS_stat_list = []
    #     std_KS_stat_path = main_dir + '/sentiment_2/' + str(number) + '/KS_stat_std.csv'
    #
    #     mean_KS_pval_list = []
    #     mean_KS_pval_path = main_dir + '/sentiment_2/' + str(number) + '/KS_pval_mean.csv'
    #     std_KS_pval_list = []
    #     std_KS_pval_path = main_dir + '/sentiment_2/' + str(number) + '/KS_pval_std.csv'
    #
    #
    #     for generate_method_name in generate_methods:  # 生成方法 5
    #         KS_stat_list = []
    #         KS_stat_path = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/KS_stat_total.csv'
    #         KS_pval_list = []
    #         KS_pval_path = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/KS_pval_total.csv'
    #         for i in range(max_sampling_time):
    #             for j in range(max_generate_sum):
    #                 generate_file = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/' + str(
    #                     i) + '_' + str(j) + '.txt'
    ...
    #     # 生成数据汇聚
    #     for generate_method_name in generate_methods:   # 生成方法 5
    #         acc_path = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
    ...
    #
    #     mean_total_path = main_dir + '/sentiment_2/' + str(number) + '/mean.csv'
    #     mean_total_list = []
    #
    #     std_total_path = main_dir + '/sentiment_2/' + str(number) + '/std.csv'
    #     std_total_list = []
    #
    ...
    #
    #     for generate_method_name in generate_methods:  # 生成方法 5
    #         generate_acc_path = main_dir + '/sentiment_2/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
